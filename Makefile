...
OBJS = comparator.o main.o minimizer.o minimize.o nucleotide.o nucleotides.o fastq_parser.o fasta_parser.o afg.o sequence.o format_parser.o input_file_reader.o overlap.o
